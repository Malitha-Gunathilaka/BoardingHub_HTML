...
.welcome-hero-txt{text-align: center;padding: 10px 160px;}
.welcome-hero-txt h1 {
    font-size: 52px;
    color: #000000;
    font-weight: 700;
...
<div class="image">
    <header>
<a href="index.php" class="Home"><img src="image/logo3.png" alt="logo" srcset="" width="450px" height="80px"></a>
        
            <button class="Hlbutton"><a href="login/login_form.html" class="Logging">Loging</a></button>
...
<footer class="bg-dark text-center text-white">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright:
    <a class="text-white" href="https://mdbootstrap.com/">DSML SOLUTIONS</a>
  </div>
  <!-- Copyright -->
</footer>
