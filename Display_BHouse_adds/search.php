...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (isset($_GET["query"])) {
        ...
        $sql = "SELECT * FROM annx WHERE Property_Type = 'Boarding House' AND Address LIKE ?"; // Replace "your_table_name" and "your_column_name" with actual table and column names
...
echo "<br><h2 class='ad-details' style='color:#1E90FF;'>&ensp;&ensp;<i class='fas fa-dollar-sign'></i> <b>RS:</b> " . $row["Price_Range"] . "</h2>"; // Icon for price range
echo '</td>';
